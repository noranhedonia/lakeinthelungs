...
typedef struct lake_list_node {
    struct lake_list_node *next;
    struct lake_list_node *prev;
} lake_list_node;

typedef lake_list_node *lake_list_iter;

typedef struct lake_list {
    lake_list_node sentinel;
} lake_list;

#define lake_list_begin(list) ((list)->sentinel.next)
#define lake_list_end(list) (&(list)->sentinel)
#define lake_list_empty(list) (lake_list_begin(list) == lake_list_end(list))
#define lake_list_next(iter) ((iter)->next)
#define lake_list_prev(iter) ((iter)->prev)
#define lake_list_front(list) ((void *)(list)->sentinel.next)
#define lake_list_back(list) ((void *)(list)->sentinel.prev)
