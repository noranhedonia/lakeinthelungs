...
#define lake_offset(o, offset) lake_reinterpret_cast(void *, lake_reinterpret_cast(uptr, o) + lake_reinterpret_cast(uptr, offset))
#define lake_offset_t(o, T) lake_offset(o, lake_ssizeof(T))

#define lake_elem(ptr, size, index) lake_offset(ptr, (size) * (index))
#define lake_elem_t(o, T, index) lake_elem(o, lake_ssizeof(T), index)
...
typedef enum lake_result : s32 {
    ...
    LAKE_ERROR_EXTENSION_NOT_PRESENT                                = -9,
    LAKE_ERROR_FEATURE_NOT_PRESENT                                  = -10,
    LAKE_ERROR_LAYER_NOT_PRESENT                                    = -11,
    LAKE_ERROR_DEVICE_LOST                                          = -12,
    LAKE_ERROR_SURFACE_LOST                                         = -13,
    LAKE_ERROR_OUT_OF_DATE                                          = -14,
    LAKE_ERROR_OUT_OF_RANGE                                         = -15,
    LAKE_ERROR_MEMORY_MAP_FAILED                                    = -16,
} lake_result;
